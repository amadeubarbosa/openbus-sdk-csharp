...
\title{Tutorial do Assistente do SDK C\# \version{} do \openbus{}}
\author{Tecgraf}
...
Uma chave privada do tipo "Org.BouncyCastle.Crypto.AsymmetricCipherKeyPair" deve ser construída através da classe utilitária "tecgraf.openbus.security.Crypto", que contém métodos para se obter uma chave privada através de uma sequência de \emph{bytes} ou de um arquivo.
