...
namespace chainvalidation {
  ...
  /// </summary>
  internal static class ExecutiveServer {
    ...
    private static void Main(String[] args) {
      ...
      ComponentContext component =
        new DefaultComponentContext(new ComponentId("executive", 1, 0, 0, ".net"));

      // Cria a faceta Message para o componente
      component.AddFacet("Message", Repository.GetRepositoryID(typeof (Message)),
                         new MessageImpl(_conn, secretaryEntity));
      ...
      _conn.OnInvalidLogin = new ChainValidationInvalidLoginCallback(entity, privateKey, ic, properties);
